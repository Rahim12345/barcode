    ...
    <div class="card shadow mb-4">
      ...
      <form action="" method="POST">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <textarea name="description" class="form-control" id="description" cols="30" placeholder="SOLİTON un pulundan 2350 AZN verdim..." rows="10" style="color:black;"></textarea>
          </div>
        </div>
        <div class="form-group row">
          <div class="col-sm-10">
