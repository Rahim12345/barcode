...
<div class="form-group row">
  ...
  <div class="col-sm-10">
    <input type="text" name="creditPay" value="<?php if($creditPay!=""){echo $creditPay;} ?>"  class="form-control" id="creditPay">
  </div>
</div>
<div class="form-group row">
  <label for="debbePay" class="col-sm-2 col-form-label">Dəbbə ödə(AZN)<sup>*</sup></label>
  <div class="col-sm-10">
    <input type="text" name="debbePay" value="<?php if($debbePay!=""){echo $debbePay;} ?>"  class="form-control" id="debbePay">
  </div>
</div>
<div class="form-group row">
...
<input type="hidden" name="hmid" value="<?php echo $hiddenMid; ?>">
</form>