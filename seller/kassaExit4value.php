    ...
    <div class="card shadow mb-4">
      ...
      <form action="" method="POST">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <textarea name="description" class="form-control" id="description" cols="30" placeholder="Vüsal Məmmədov  2350 manat pul götürdü..." rows="10" style="color:black;"><?php if(strlen($description)!=0){ echo $description; } ?></textarea>
          </div>
        </div>
        <div class="form-group row">
          <div class="col-sm-10">
