    ...
    <div class="card shadow mb-4">
      ...
      <form action="" method="POST">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="number" name="salary" class="form-control" id="salary" placeholder="350" min="0" max="1000000" style="color:black;">
          </div>
        </div>
        <div class="form-group row">
          <label for="bonus" class="col-sm-2 col-form-label">Bonus <sup>*</sup></label>
          <div class="col-sm-10">
            <input type="number" name="bonus" class="form-control" id="bonus" placeholder="50" min="0" max="1000000" style="color:black;">
          </div>
        </div>
        <div class="form-group row">
          <label for="priz" class="col-sm-2 col-form-label">Bayram pulu <sup>*</sup></label>
          <div class="col-sm-10">
            <input type="number" name="priz" class="form-control" id="priz" placeholder="30" min="0" max="1000000" style="color:black;">
          </div>
        </div>
        <div class="form-group row">
          <label for="description" class="col-sm-2 col-form-label">Təsvir yaz <sup>*</sup></label>
          <div class="col-sm-10">
            <textarea name="description" class="form-control" id="description" cols="30" placeholder="Satıcı Süleymanov Rahim Camal oğluna 350 manat əmək haqqı,50 manat bonus və 30 manat bayram pulu verildi" rows="10" style="color:black;"></textarea>
          </div>
        </div>
        <div class="form-group row">
          <div class="col-sm-10">
