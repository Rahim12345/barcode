<div class="card">
    <div class="py-3">
    <h6 class="m-0 font-weight-bold text-primary bg-info" id="back" style="background-color: orange;padding-left: 15px;border-radius: 10px;line-height: 40px;text-align: center;color: white;">
      <a href="index.php?id=14" style="color: white;"><i class="fa fa-arrow-left" aria-hidden="true"></i> Geri dön</a>
    </h6>
    <br>
    <h6 class="m-0 font-weight-bold text-primary bg-info" id="alert" style="background-color: orange;padding-left: 15px;border-radius: 10px;line-height: 40px;text-align: center;color: white;">
      <button class="btn btn-primary" style="line-height: 40px;" onclick="prinTorder();">Çapa hazırla</button>
    </h6>
    <button class="btn btn-primary" onclick="window.print();" style="display: none;" id="print-btn" onmouseout ="printTorder2();">Çap et</button>
  </div>
    <div class="card-body">
     <table class="table table-light"  style="width: 100%;color:white;border: 2px solid black;page-break-after: always;">
      ...
      <tbody style="border: 2px solid black;color: black;">
        ...
        <tr>
          ...
          <td colspan="3">
            <span class="form-control" style="border-radius: 0;border:none;background-color: white; ">
              <?php echo $satılan_malın_adı; ?>
            </span>
          </td>
        </tr>
        <tr>
