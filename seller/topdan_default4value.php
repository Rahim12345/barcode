    ...
    ?>
        <tr>
          ...
          <td>
            ...
            <input class='form-control' style='border:none;border-bottom:1px solid black;border-radius:0px;background-color:white;font-size: 1vw;' type='hidden' name='productNames[]' value="<?php echo $mallar[$i] ?>">
            <span class="form-control" style="font-size: 1vw;"><?php echo $mallar[$i]; ?></span>
          </td>
          <td>
            <input class='form-control' style='border:none;border-bottom:1px solid black;border-radius:0px;background-color:white;font-size: 1vw;' type='hidden' name='models[]' value="<?php echo $modeller[$i] ?>">
            <span class="form-control" style="font-size: 1vw;"><?php echo $modeller[$i]; ?></span>
          </td>
          <td>
            <input class='form-control' style='border:none;border-bottom:1px solid black;border-radius:0px;background-color:white;font-size: 1vw;' type='hidden' name='serias[]' value="<?php echo $serialar[$i] ?>">
            <span class="form-control" style="font-size: 1vw;"><?php echo $serialar[$i]; ?></span>
          </td>
          <td>
            <input class='form-control pricess'  style='border:none;border-bottom:1px solid black;border-radius:0px;background-color:white;font-size: 1vw;' type='hidden' name='prices[]' value="<?php echo $qiymetler[$i] ?>">
