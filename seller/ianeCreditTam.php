...
$UpdateReject=$conn->prepare("UPDATE `creditdetails` SET `productDetails`=?,`rejectedProducts`=?,`productPrice`=?,`firstPrice`=?,`remindMoney`=?,`amountPaid`=?,`rejectId`=?,`rejectName`=? WHERE id=?");
$UpdateReject->execute([$pro,$newRejected,0,0,0,0,$uid,$rejectExecName,$mid]);
