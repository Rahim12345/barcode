<div class="card shadow mb-4">
  ...
  <form action="" method="POST">
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <input type="date" name="start" class="form-control" id="start" placeholder="15.02.2020" maxlength="51">
      </div>
    </div>
    <div class="form-group row">
      <label for="finish" class="col-sm-2 col-form-label">Son tarix <sup>*</sup></label>
      <div class="col-sm-10">
        <input type="date" name="finish" class="form-control" id="finish" placeholder="25.04.2020" maxlength="51">
      </div>
    </div>
    <div class="form-group row">
