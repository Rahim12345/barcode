<div class="card shadow mb-4">
  ...
  <div class="card-body">
    <p><a href="index.php?id=8"> &ltGeri dön </a></p>
    <p style="background-color: orange;color:white;line-height: 40px;padding-left: 15px;border-radius: 10px;">Qeyd:Yalnız şifrənizi dəyişə bilərsiniz</p>
  <form action="" method="POST">
    <div class="form-group row">
      <label for="name" class="col-sm-2 col-form-label">Ad <sup>*</sup></label>
      <div class="col-sm-10">
        <input type="text" name="nameUpdate" class="form-control" id="name" value="<?php echo $name; ?>" maxlength="51" disabled>
      </div>
    </div>
    <div class="form-group row">
