<div class="card shadow mb-4">
    <div class="card-body">
         <table class="table table-dark" style="width: 100%;">
            ...
            <tr>
                  <th scope="col" colspan="3"  style="text-align: center;">İşçi və ya işçilərin girişini blokla</th>
            </tr>
                <tr>
                  <th scope="col">№</th>
                  ...
                  if(isset($_POST["permit"]))
                  {
                        ...
                        if(isset($_POST['permitInputs']))
                        {
                              ...
                              if($count4Workers!=0)
                              {
                                    ...
                                    $UpdatePermit=$conn->prepare("UPDATE `users` SET `doorKey`=? WHERE  id=?");
                              ...
                              include 'holiday_default.php';
                        }
                        else
                        {
                              $UpdatePermit=$conn->prepare("UPDATE `users` SET `doorKey`=? WHERE  status!=?");
