		  ...
		  <tbody style="background-color: #1c4b79;">
		  	...
		  	foreach($rows4Warehouse as $row4Warehouse)
		  	{
				...
				<tr>
			      ...
			      <td><a href="share.php?id=<?php echo $pid; ?>&address=<?php echo $row4Warehouse["name"]; ?>"><?php echo $row4Warehouse["name"]; ?></a></td>
			    </tr>
		  		<?php
		  	}
			...
			foreach($rows4Store as $row4Store)
		  	{
				...
				<tr>
			      <th scope="row"><?php echo $n; ?></th>
			      <td><a href="share.php?id=<?php echo $pid; ?>&address=<?php echo $row4Store["name"]; ?>"><?php echo $row4Store["name"]; ?></a></td>
			    </tr>
		  		<?php
		  	}
}
