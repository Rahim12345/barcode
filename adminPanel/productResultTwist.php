<?php  
$query4Results=$conn->prepare("SELECT * FROM products WHERE (warehouse=? AND model=?) AND selled=? ORDER BY warehouse");
...
if($count==0)
{
echo "<u>$warehouseS</u> + <u>$models</u> &nbspüzrə  heç bir məhsul tapılmadı";
}
else
{
echo "<u>$warehouseS</u> + <u>$models</u> &nbspüzrə  $count ədəd məhsul tapıldı";
} 
?>
</p>
